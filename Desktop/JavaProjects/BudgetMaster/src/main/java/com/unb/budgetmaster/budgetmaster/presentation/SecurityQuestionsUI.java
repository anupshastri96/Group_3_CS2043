...
public class SecurityQuestionsUI {
    ...
    public void getContent(BorderPane root, ArrayList<String> loginInformation, Boolean isNewUser) {
    ...
    private void submitEvent(BorderPane root, Boolean isNewUser, ArrayList<String> loginInformation, String question1, String answer1, String question2, String answer2, Text incorrectText) {
